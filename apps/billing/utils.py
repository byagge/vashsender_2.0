...
def get_user_plan_info(user):
    ...
    return {
        ...
        'subscribers_limit': active_plan.plan.subscribers if active_plan.plan.plan_type.name == 'Subscribers' else None,
        'emails_sent': actual_sent,
        'emails_remaining': emails_remaining if active_plan.plan.plan_type.name == 'Letters' else None,
