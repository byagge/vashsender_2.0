...
class DomainAdmin(admin.ModelAdmin):
    list_display = ('domain_name', 'owner', 'is_verified', 'spf_verified', 'dkim_verified', 'created_at')
    list_filter = ('is_verified', 'spf_verified', 'dkim_verified', 'created_at')
...
class SenderEmailAdmin(admin.ModelAdmin):
    list_display = ('email', 'domain', 'owner', 'is_verified', 'created_at', 'verified_at')
    list_filter = ('is_verified', 'created_at', 'verified_at')
    search_fields = ('email', 'domain__domain_name', 'owner__email')
