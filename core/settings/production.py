...
EMAIL_BATCH_SIZE = config('EMAIL_BATCH_SIZE', default=100, cast=int)  # Увеличено для скорости
...
EMAIL_RETRY_DELAY = config('EMAIL_RETRY_DELAY', default=60, cast=int)  # Уменьшено для скорости
